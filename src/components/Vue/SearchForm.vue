...
<template>
  <div class="flex h-3/4 w-5/6 flex-col items-center justify-center space-y-12">
    <article class="flex w-5/12 flex-col items-center justify-center space-y-4 rounded-md bg-Woodsmoke-900/60 px-4 py-1">
      ...
      <form @submit.prevent="queryBooks" method="get" class="flex w-full flex-col items-center justify-center space-y-4 pb-1">
        <section class="flex w-full items-center justify-around">
          <input v-model="title" type="text" autocomplete="off" name="title" id="title" placeholder="Title" class="w-5/12 rounded-md bg-Woodsmoke-900/80 px-2 py-0.5 text-lg outline-0 placeholder:text-base placeholder:italic" />
          <input v-model="author" type="text" autocomplete="off" name="author" id="author" placeholder="Author" class="w-5/12 rounded-md bg-Woodsmoke-900/80 px-2 py-0.5 text-lg outline-0 placeholder:text-base placeholder:italic" />
        </section>
